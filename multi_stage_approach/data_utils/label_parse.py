...
class LabelParser(object):
    def __init__(self, labels_col, elem_col, intermittent=False):
        ...
        :param elem_col: ["subject", "object", "aspect", "predicate", "label"]
    ...
    def parse_sequence_label(self, split_symbol="&&", sent_col=None, file_type="vie"):
        """
        :param split_symbol:
        :param sent_col:
        :param file_type
        :return: elem_representation_col and pair_tuple_col
        """
