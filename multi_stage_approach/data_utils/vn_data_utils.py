...
class DataGenerator(object):
    def __init__(self, config):
        ...
        self.elem_col = ["subject", "object", "aspect", "predicate", "label"]
    ...
    def create_data_dict(self, data_path, data_type, label_path=None):
        ...
        LP = LabelParser(labels_col, self.elem_col)
        elem_col, pair_tuple_col = LP.parse_sequence_label("&&", sent_col, file_type="vie")
